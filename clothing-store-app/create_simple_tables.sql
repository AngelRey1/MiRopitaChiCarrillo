-- Script simple para crear tablas de pedidos, devoluciones y ventas
USE myropitacarrillochi;

-- 1. Crear tabla de pedidos (sin foreign keys por ahora)
...
-- 6. Crear tabla de detalles de ventas
