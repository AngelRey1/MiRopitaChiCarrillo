...
-- 1. Agregar campo de último inicio de sesión a la tabla de usuarios existente
...
-- 3. Crear tabla de usuarios_roles para asignar roles a usuarios
...
-- 7. Crear tabla de detalles de pedidos
...
-- 10. Asignar rol de admin al primer usuario (ajustar el ID según corresponda)
